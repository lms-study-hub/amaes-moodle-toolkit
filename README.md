...
- **💡 Pro Tips & Tricks (Hands-Free Speedrun)**:
  - **Auto-Next to Review & Data Check**: Picking an answer (via click, `1-4`, or `V` clipboard paste) automatically advances pages, submits the quiz summary, and lands on the Review screen to immediately check questions and harvest verified teacher answers & eliminated wrong choices into the database!
